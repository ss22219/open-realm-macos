...
typedef struct {
    ...
    FLOAT volume;
    FLOAT pitch;
    FLOAT minDistance, maxDistance, distanceCutoff;
    FLOAT coneInside, coneOutside, coneOutsideVolume;
    VECTOR3 coneOrientation, velocity;
    BOOL hasVelocity;
    BOOL playing, stopped, killWhenDone;
} gsound_t;
